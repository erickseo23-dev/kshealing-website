...
export default function Ejercicio7() {
  ...
  return (
    <EjercicioLayout>
      {/* Header Mejorado */}
      <div className="bg-gradient-to-r from-orange-600/20 via-red-600/20 to-rose-600/20 border-b border-border relative overflow-hidden">
        {/* Fondo decorativo */}
        ...
        <div className="container py-12 relative z-10">
          <div className="flex items-start gap-6 mb-6">
            <div className="p-4 bg-gradient-to-br from-orange-600 to-red-600 rounded-lg">
      ...
      <div className="container py-12">
        ...
        <EjercicioCard
          ...
          colorClass="from-orange-600/10 to-red-600/10"
          variant="intro"
        >
          ...
          <div className="lg:col-span-2">
            <section>
              ...
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-orange-600 to-red-600 rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000" />
                <div className="relative bg-gradient-to-br from-orange-600 to-red-600/10 rounded-lg overflow-hidden border border-border aspect-video flex items-center justify-center">
                  <div className="text-center">
                    <div className="mb-4 inline-block p-4 bg-orange-500/20 rounded-full">
                      <Wind className="w-8 h-8 text-orange-500 animate-spin" />
                    </div>
        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-orange-600 to-red-600/10 rounded-lg border border-orange-500/20">
            ...
            <Button
              ...
              className={`gap-2 whitespace-nowrap ${
                completed
                  ...
                  : "bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 to-red-700"
              }`}
            >
