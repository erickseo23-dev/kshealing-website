...
export default function Ejercicio2() {
  ...
  return (
    <ProtectedEjercicio ejercicioNumber={2}>
      <EjercicioLayout>
      {/* Header */}
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <p className="text-sm text-muted-foreground mt-4">
              Realiza este ejercicio después de completar el Ejercicio 1. La activación del Campo KS prepara tu sistema para recibir esta transmisión de manera más profunda.
            </p>
          </section>
