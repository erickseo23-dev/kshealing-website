          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                { num: "VI", title: "El Cuerpo KS", desc: "Estructura multidimensional y activación del Cuerpo KS" },
                { num: "VII", title: "La Carta de YOHEV", desc: "Mensaje directo a los primeros alumnos y buscadores" },
                { num: "VIII", title: "La Ciencia de la Energía", desc: "Integración de ciencia cuántica y espiritualidad" },
                { num: "IX", title: "La Consciencia Expandida", desc: "Acceso a estados más profundos de presencia y claridad" },
                { num: "X", title: "El Campo Electromagnético", desc: "Cómo el Cuerpo KS impacta tu entorno y realidad" },
                { num: "XI", title: "La Geometría Divina", desc: "El Toroide y los sistemas energéticos del universo" },
                { num: "XII", title: "Ejercicios Prácticos I", desc: "Primeros 5 ejercicios para activar tu Cuerpo KS (con QR)" },
                { num: "XIII", title: "Ejercicios Prácticos II", desc: "Ejercicios avanzados para profundizar (con QR)" },
                { num: "XIV", title: "Integración en la Vida", desc: "Cómo aplicar KS Healing en tu vida cotidiana" },
                { num: "XV", title: "Preguntas Frecuentes", desc: "Respuestas a las preguntas más comunes de practicantes" },
                { num: "XVI", title: "Testimonios", desc: "Historias de transformación de practicantes certificados" },
                { num: "XVII", title: "El Siguiente Paso", desc: "Tu camino como practicante de KS Healing" },
                { num: "XVIII", title: "Ser un Sol en la Tierra", desc: "La visión final: vivir como un sol en la tierra" },
              ].map((chapter) => (
