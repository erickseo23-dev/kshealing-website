...
export default function Ejercicio5() {
  ...
  return (
    <EjercicioLayout>
      ...
      <div className="bg-gradient-to-r from-green-700/20 via-teal-600/20 to-cyan-600/20 border-b border-border relative overflow-hidden">
        {/* Fondo decorativo */}
        ...
        <div className="container py-12 relative z-10">
          <div className="flex items-start gap-6 mb-6">
            <div className="p-4 bg-gradient-to-br from-green-600 to-teal-600 rounded-lg">
      ...
      <div className="container py-12">
        ...
        <EjercicioCard
          ...
          colorClass="from-green-600/10 to-teal-600/10"
          variant="intro"
        >
          ...
          <div className="lg:col-span-2">
            <section>
              ...
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-green-600 to-teal-600 rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000" />
                <div className="relative bg-gradient-to-br from-green-600/10 to-teal-600/10 rounded-lg overflow-hidden border border-border aspect-video flex items-center justify-center">
                  <div className="text-center">
                    <div className="mb-4 inline-block p-4 bg-teal-600/20 rounded-full">
                      <Wind className="w-8 h-8 text-teal-500 animate-spin" />
                    </div>
              ...
              <div className="mt-4 p-4 bg-card rounded-lg border border-border">
                <p className="text-sm text-muted-foreground flex items-start gap-2">
                  <span className="text-teal-500 font-bold flex-shrink-0 mt-1">
                    ⏱
                  </span>
                  <span>
        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-green-600/10 to-teal-600/10 rounded-lg border border-teal-500/20">
