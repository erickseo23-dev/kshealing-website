...
export default function Ejercicio3() {
  ...
  return (
    <ProtectedEjercicio ejercicioNumber={3}>
      <EjercicioLayout>
      {/* Header */}
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <p className="text-sm text-muted-foreground mt-4">
              Este ejercicio es más efectivo después de haber completado los dos ejercicios anteriores. Tu sistema estará mejor preparado para recibir la transmisión sanadora.
            </p>
          </section>
