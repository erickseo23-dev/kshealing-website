  ...
  return (
    <EjercicioLayout>
          ...
          <div className="flex items-start gap-6 mb-6">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-2">
                Expandir tu Intuición
              </h1>
              <p className="text-lg text-muted-foreground">
                Abre tu tercer ojo y accede a la sabiduría infinita
              </p>
            </div>
          </div>
      ...
      <div className="container py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 my-12">
          ...
          <div className="lg:col-span-2">
            <section>
              ...
              {/* Video */}
              <YouTubeVideo videoId="JMuStZ8c9Co" />
        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-blue-900 to-slate-600/10 rounded-lg border border-violet-500/20">
            ...
            <Button
              ...
              className={`gap-2 whitespace-nowrap ${
                completed
                  ...
                  : "bg-gradient-to-r from-blue-900 to-slate-600 hover:from-violet-700 to-purple-700"
              }`}
            >
