  ...
  return (
    <EjercicioLayout>
      ...
      <div className="container py-12">
          ...
          <div className="lg:col-span-2">
            <section>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gradient-to-br from-blue-800/10 to-slate-600/10 rounded-lg overflow-hidden border border-border">
                  <YouTubeVideo videoId="jXZHRRpqApk" />
                </div>
              </div>
        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-blue-800/10 to-slate-600/10 rounded-lg border border-pink-500/20">
            ...
            <Button
              ...
              className={`gap-2 whitespace-nowrap ${
                completed
                  ...
                  : "bg-gradient-to-r from-blue-900 to-slate-600 hover:from-pink-700 hover:to-purple-700"
              }`}
            >
