    ...
    <EjercicioLayout>
      ...
      <div className="bg-gradient-to-r from-indigo-900/20 via-indigo-700/20 to-slate-600/20 border-b border-border relative overflow-hidden">
        ...
        <div className="container py-12 relative z-10">
          <div className="flex items-start gap-6 mb-6">
            <div className="p-4 bg-gradient-to-br from-indigo-800 to-slate-500 rounded-lg">
      ...
      <div className="container py-12">
        ...
        <EjercicioCard
          ...
          colorClass="from-indigo-800/10 to-slate-500/10"
          variant="intro"
        >
          ...
          <div className="lg:col-span-2">
            <section>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gradient-to-br from-indigo-800/10 to-slate-500/10 rounded-lg overflow-hidden border border-border aspect-video flex items-center justify-center">
        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-indigo-800/10 to-slate-500/10 rounded-lg border border-pink-500/20">
            ...
            <Button
              ...
              className={`gap-2 whitespace-nowrap ${
                completed
                  ...
                  : "bg-gradient-to-r from-indigo-900 to-slate-600 hover:from-pink-700 hover:to-purple-700"
              }`}
            >
