      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-background via-primary/5 to-slate-900/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <img 
                src="https://private-us-east-1.manuscdn.com/sessionFile/cJ0NsjiTEgFuWB5HAN1kHs/sandbox/iGSDDzIRXcH5A0CLxFJ7HR-img-2_1770062985000_na1fn_a3MtaGVhbGluZy10cmFpbmluZy1taXhlZA.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=O36lGOcnTOVuB-zHHZN~i~8BBZlfFXXTk8i~lzOxk0DlfI8Wujy7KHdMnCk0LveglJkhq2QBvxH7lqSxouQRCaLKkYY6oe1WYIUzhjOHZieD0k~MAFtu9yUBk5ChUMiSWiGoxzNYg-9oqgdqmUVM7v8GPZqXqBXN2WJ5k19Mz~QeabKpwcM3ieG5dxb7WcSolGfEwq2Wp7vPiTNWND4iof7jyaLozZDv-jGmR8IoZFQJCcpkuPgdTm86gspJoqcWA2nTYPOOi0qf25XVTP~oxq4G-skV-GXKAxF33OXWw67NMDH17-TewWsODbskg9v3oXBtLp0y-8Y2-H0CtF3rpQ__" 
                alt="Instructora entrenando a estudiante masculino" 
                className="w-full h-80 object-cover group-hover:scale-110 transition-transform duration-300"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
