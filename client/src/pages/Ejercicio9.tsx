  ...
  return (
    <EjercicioLayout>
      ...
      <div className="bg-gradient-to-r from-slate-600/20 via-slate-500/20 to-slate-400/20 border-b border-border relative overflow-hidden">
        ...
        <div className="container py-12 relative z-10">
          <div className="flex items-start gap-6 mb-6">
            <div className="p-4 bg-gradient-to-br from-slate-600 to-slate-600 rounded-lg">
      ...
      <div className="container py-12">
        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-slate-600 to-slate-600/10 rounded-lg border border-yellow-500/20">
            ...
            <Button
              ...
              className={`gap-2 whitespace-nowrap ${
                completed
                  ...
                  : "bg-gradient-to-r from-slate-600 to-slate-600 hover:from-slate-600 to-slate-600"
              }`}
            >
