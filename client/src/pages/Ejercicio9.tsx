...
export default function Ejercicio9() {
  ...
  const exerciseNumber = 9;
  const totalExercises = 10;

  return (
    <EjercicioLayout>
      {/* Header Mejorado */}
      <div className="bg-gradient-to-r from-slate-600/20 via-slate-500/20 to-slate-400/20 border-b border-border relative overflow-hidden">
        {/* Fondo decorativo */}
        ...
        <div className="container py-12 relative z-10">
          <div className="flex items-start gap-6 mb-6">
            <div className="p-4 bg-gradient-to-br from-slate-600 to-amber-500 rounded-lg">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Activa tu luz interior y brilla con tu verdadero poder
              </p>
            </div>
          </div>
      ...
      <div className="container py-12">
        ...
        <EjercicioCard
          ...
          colorClass="from-slate-600/10 to-slate-500/10"
          variant="intro"
        >
          ...
          <div className="lg:col-span-2">
            <section>
              ...
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-slate-600 to-amber-500 rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000" />
                <div className="relative bg-gradient-to-br from-slate-600 to-slate-500/10 rounded-lg overflow-hidden border border-border aspect-video flex items-center justify-center">
        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-slate-600 to-slate-500/10 rounded-lg border border-yellow-500/20">
            ...
            <Button
              ...
              className={`gap-2 whitespace-nowrap ${
                completed
                  ...
                  : "bg-gradient-to-r from-slate-600 to-amber-500 hover:from-slate-600 to-amber-500"
              }`}
            >
