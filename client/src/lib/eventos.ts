...
export const eventos: Event[] = [
  ...
  {
    id: "evento-005",
    title: "Activación en vivo de Libro KS Healing, con YOHEV",
    description: "Sesión de activación en vivo del Libro KS Healing. Transmisión directa de Energía KS con YOHEV.",
    date: "2026-05-19",
    startTime: "15:00",
    endTime: "17:00",
    timezone: "America/Mexico_City",
